/* HP A500-6X server (rp2470) */
/* AUTO-GENERATED HEADER FILE FOR SEABIOS FIRMWARE */
/* generated with Linux kernel */
/* search for PARISC_QEMU_MACHINE_HEADER in Linux */
#if 0
Found devices:
1. Crescendo 650 W2 [160] at 0xfffffffffffa0000 { type:0, hv:0x5e2, sv:0x4, rev:0x0 }
2. Crescendo 650 W2 [162] at 0xfffffffffffa2000 { type:0, hv:0x5e2, sv:0x4, rev:0x0 }
3. Memory [8] at 0xfffffffffed08000 { type:1, hv:0x9b, sv:0x9, rev:0x0 }
4. Astro BC Runway Port [0] at 0xfffffffffed00000 { type:12, hv:0x582, sv:0xb, rev:0x0 }
5. Elroy PCI Bridge [0:0] at 0xfffffffffed30000 { type:13, hv:0x782, sv:0xa, rev:0x0 }
6. Elroy PCI Bridge [0:2] at 0xfffffffffed34000 { type:13, hv:0x782, sv:0xa, rev:0x0 }
7. Elroy PCI Bridge [0:4] at 0xfffffffffed38000 { type:13, hv:0x782, sv:0xa, rev:0x0 }
8. Elroy PCI Bridge [0:6] at 0xfffffffffed3c000 { type:13, hv:0x782, sv:0xa, rev:0x0 }
#endif

#define PARISC_MODEL     "9000/800/A500-6X"
#define PARISC_MODEL_MPE ""

#define PARISC_PDC_MODEL 0x5e20, 0x491, 0x0, 0x1, 2004000500, 0x100000f0, 0x8, 0xb2, 0xb2, 0x1
...
#define PARISC_PDC_ENTRY_ORG 0xf0f0047100
...
#define HPA_fffffffffffa0000_DESCRIPTION "Crescendo 650 W2"
...
#define HPA_fffffffffffa2000_DESCRIPTION "Crescendo 650 W2"
...
static struct pdc_module_path mod_path_hpa_fffffffffffa2000 = {
	.path = { .flags = 0xff, .bc = { 0xff, 0xff, 0xff, 0xff, 0xff, 0xff }, .mod = 0xa2 }
};
...
static struct pdc_module_path mod_path_hpa_fffffffffed08000 = {
	.path = { .flags = 0xff, .bc = { 0xff, 0xff, 0xff, 0xff, 0xff, 0xff }, .mod = 0x08 }
};
...
static struct pdc_module_path mod_path_hpa_fffffffffed00000 = {
	.path = { .flags = 0xff, .bc = { 0xff, 0xff, 0xff, 0xff, 0xff, 0xff }, .mod = 0x00 }
};
...
static struct pdc_module_path mod_path_hpa_fffffffffed30000 = {
	.path = { .flags = 0xff, .bc = { 0xff, 0xff, 0xff, 0xff, 0xff, 0x00 }, .mod = 0x00 }
};
...
static struct pdc_module_path mod_path_hpa_fffffffffed34000 = {
	.path = { .flags = 0xff, .bc = { 0xff, 0xff, 0xff, 0xff, 0xff, 0x00 }, .mod = 0x02 }
};
...
static struct pdc_module_path mod_path_hpa_fffffffffed38000 = {
	.path = { .flags = 0xff, .bc = { 0xff, 0xff, 0xff, 0xff, 0xff, 0x00 }, .mod = 0x04 }
};
...
static struct pdc_module_path mod_path_hpa_fffffffffed3c000 = {
	.path = { .flags = 0xff, .bc = { 0xff, 0xff, 0xff, 0xff, 0xff, 0x00 }, .mod = 0x06 }
};
